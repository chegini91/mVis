    ...
    public static void infiniteStreamingRecognize() throws Exception {
        ...
        class MicBuffer implements Runnable {
            ...
            public void run() {
                ...
                SearchUtility.parentController.getConsolePaneController().
                        appendTextFromConsole("Start speaking...\n");
...
//TODO put your file steam
        CredentialsProvider credentialsProvider
                = FixedCredentialsProvider.create(ServiceAccountCredentials.fromStream(new FileInputStream("")));
        ...
        try ( SpeechClient client = SpeechClient.create(settings)) {
            ...
            responseObserver
                ...
                public void onResponse(StreamingRecognizeResponse response) {
                    ...
                    SearchUtility.parentController.getConsolePaneController().
                            appendTextFromConsole("Transcript :" + alternative.getTranscript() + "\n");
